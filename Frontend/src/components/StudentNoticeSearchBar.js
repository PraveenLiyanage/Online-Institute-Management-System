...
import StudentNoticeDetails from "./StudentNoticeDetails";
import jsPDF from "jspdf";
import "../notice.css";

const StudentNoticeSearchBar = () => {
    ...
    <tr>
      ...
      <th id="th3">Notice date</th>
          ...
          {filteredNotices.map((notice) => (
            ...
            <StudentNoticeDetails key={notice._id} notice={notice} />
          ))}
...
export default StudentNoticeSearchBar;
