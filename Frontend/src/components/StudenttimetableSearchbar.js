...
import StudenttimetableDetail from "./StudenttimetableDetail";
import jsPDF from "jspdf";
import "../timetable.css";

const StudenttimetableSearchbar = () => {
  ...
  return (
    ...
    <div>
      ...
      <div className="card" id ="timetablecard">
      <table id ="tt1">
      <thead>
    <tr>
      ...
      <th id="tth6">3.00 p.m. - 6.00 p.m</th>
          ...
          {filteredTimetables.map((timetable) => (
            ...
            <StudenttimetableDetail key={timetable._id} timetable={timetable} />
          ))}
...
export default StudenttimetableSearchbar;